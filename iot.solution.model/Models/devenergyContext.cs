...
{
    public partial class devenergyContext : DbContext
    {
        public devenergyContext()
        {
        }

        public devenergyContext(DbContextOptions<devenergyContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<AdminRule>(entity =>
            {
                entity.HasKey(e => e.Guid)
                    .HasName("PK__AdminRul__497F6CB497060C9E");
            ...
            {
                entity.HasKey(e => e.Guid)
                    .HasName("PK__Attribut__497F6CB45B0DDDBE");
            ...
            {
                entity.HasKey(e => e.Guid)
                    .HasName("PK__Company__497F6CB404DEA334");
            ...
            {
                entity.HasKey(e => e.Guid)
                    .HasName("PK__CompanyC__497F6CB4758156AA");
            ...
            {
                entity.HasKey(e => e.Guid)
                    .HasName("PK__Configur__497F6CB475A579CD");
            ...
            {
                entity.HasKey(e => e.Guid)
                    .HasName("PK__IOTConne__497F6CB48AD24936");
            ...
            {
                entity.HasKey(e => e.Guid)
                    .HasName("PK__KitTypeA__497F6CB4F32A4E91");
            ...
            {
                entity.HasKey(e => e.Guid)
                    .HasName("PK__Module__497F6CB4B187917E");
            ...
            {
                entity.HasKey(e => e.Guid)
                    .HasName("PK__RoleModu__497F6CB471E3BC38");
            ...
            {
                entity.HasKey(e => e.Guid)
                    .HasName("PK__Telemetr__497F6CB4CDC7745B");
            ...
            {
                entity.HasKey(e => e.Guid)
                    .HasName("PK__Telemetr__497F6CB4F074B332");
